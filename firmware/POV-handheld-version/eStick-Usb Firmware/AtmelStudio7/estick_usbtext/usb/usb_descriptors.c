...
//!
//! @version 1.1 at90usb162-hidgen-1_0_1 $Id: usb_descriptors.c,v 1.1 2006/12/12 09:48:04 arobert Exp $
//!
//! @todo
//! @bug
...
code S_usb_user_configuration_descriptor usb_conf_desc = {
 ...
 , Usb_write_word_enum_struc(sizeof(S_usb_configuration_descriptor)+sizeof(S_usb_interface_descriptor)\
   +sizeof(S_usb_hid_descriptor)+sizeof(S_usb_endpoint_descriptor)+sizeof(S_usb_endpoint_descriptor))
 , NB_INTERFACE
 , CONF_NB
 , CONF_INDEX
 , CONF_ATTRIBUTES
